	...
	protected:
		...
		virtual void DefineRules()
		{
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Type",
				...
				"Type of dynamic boundaries: TEMPERATURE_VELOCITY_SLOPES | FIXED_STRAINRATE_FUEL_TEMPERATURE_SLOPE | FIXED_STRAINRATE_OX_TEMPERATURE_SLOPE | FIXED_BALANCE_FUEL_VELOCITY_SLOPE | FIXED_BALANCE_OX_VELOCITY_SLOPE",
				true));
			...
			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@Frequency",
				OpenSMOKE::SINGLE_MEASURE,
				"Frequency of sinusoidal signal (default: 0)",
				false));

			AddKeyWord(OpenSMOKE::OpenSMOKE_DictionaryKeyWord("@SemiAmplitude",
				OpenSMOKE::SINGLE_DOUBLE,
