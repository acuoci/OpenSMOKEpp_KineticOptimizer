...
#ifndef OpenSMOKE_OptimizationRules_CounterFlow1DFlameExperiment_H
#define OpenSMOKE_OptimizationRules_CounterFlow1DFlameExperiment_H

namespace OpenSMOKE
{
	class Grammar_OptimizationRules_CounterFlow1DFlameExperiment : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
	...
	class OptimizationRules_CounterFlow1DFlameExperiment
	{
	public:
	...
	void OptimizationRules_CounterFlow1DFlameExperiment::SetupFromDictionary(OpenSMOKE::OpenSMOKE_Dictionary& dictionary, OpenSMOKE::OpenSMOKE_DictionaryManager& dictionaries)
	{
		Grammar_OptimizationRules_CounterFlow1DFlameExperiment grammar;
...
#endif // OpenSMOKE_OptimizationRules_CounterFlow1DFlameExperiment_H