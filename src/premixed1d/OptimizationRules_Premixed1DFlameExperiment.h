...
#ifndef OpenSMOKE_OptimizationRules_Premixed1DFlameExperiment_H
#define OpenSMOKE_OptimizationRules_Premixed1DFlameExperiment_H

namespace OpenSMOKE
{
	class Grammar_OptimizationRules_Premixed1DFlameExperiment : public OpenSMOKE::OpenSMOKE_DictionaryGrammar
	{
	protected:
	...
	class OptimizationRules_Premixed1DFlameExperiment
	{
	public:
	...
	void OptimizationRules_Premixed1DFlameExperiment::SetupFromDictionary(OpenSMOKE::OpenSMOKE_Dictionary& dictionary, OpenSMOKE::OpenSMOKE_DictionaryManager& dictionaries)
	{
		Grammar_OptimizationRules_Premixed1DFlameExperiment grammar;
...
#endif // OpenSMOKE_OptimizationRules_Premixed1DFlameExperiment_H